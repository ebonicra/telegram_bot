Суть игры в виде телеграм бота
==================

        🔸 Пользователь - улитка!
        🔸 У него есть какой-то уровень айкью. Чем он выше, тем меньше он пьянеет.
        🔸 Повысить свой айкью он может общаясь с разными персонажами, узнавая у них новые виды алкоголя, рецепты коктейлей или барменские приблуды.
        🔸 Бармены - главные враги, их надо перепить.
        🔸 У барменов тоже есть свой уровень айкью, и если он выше уровня героя, то пить с этим барменом пока герой не может.
        🔸 Чтобы перепить бармена надо выкинуть виртуальный кубик. Чем выше значение на кубике, тем выше урон опьянению.
        🔸 Некоторые персонажи могут давать пользователю квесты. За прохождение квестов он получает money.
        🔸 Money можно потратить в магазине на всякую дребедень.
        🔸 Если пользователь слишком пьян - совет сходить в туалет проветриться.
